<?php
##---------------------------Visual--------------------------------##
# webAccordeon($aImageArray, $aTitleArray, $aSubtitleArray, $aTextArray);        //Receives text
