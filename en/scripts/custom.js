...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function init_template(){
        ...
        if(splide.length){
            ...
            var quintupleSlider = document.querySelectorAll('.quintuple-slider');
            if(quintupleSlider.length){
                quintupleSlider.forEach(function(e){
                     var quintuple = new Splide( '#'+e.id, {
                        type:'loop',
                        autoplay:false,
                        padding: {
                            left:'0px',
