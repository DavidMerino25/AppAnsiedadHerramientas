...
var lineChartAnsi = document.querySelectorAll('#line-chartansi')[0]
...
// Grafica de escaneos ansiedad
if (lineChartAnsi) {
	var lineDemoChart = new Chart(lineChartAnsi, {
		type: 'line',
		data: {
			labels: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
			datasets: [{
				data: [9, 0, 3, 7, 6, 20, 64, 62],
				label: "Anxiety",
				fill:true,
